...
const Category = ({ category, handleCategoryDetails }) => {
    const { id, image, category_name, title, cardBgColor, categoryBgColor, categoryTextColor, titleTextColor
    } = category;
    return (
        <div onClick={() => handleCategoryDetails(id)} style={{ backgroundColor: cardBgColor }} className=" space-y-3 pb-5 rounded-md" >
